...
function ScheduleReport() {
  ...
  const reportColumns = [
    ...
    { accessorKey: 'assiggnedName', header: 'Assigned Name', size: 80 },
    { accessorKey: 'assignedTo', header: 'Assigned To', size: 80 },
