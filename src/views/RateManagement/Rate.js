              ...
              <div className="row d-flex ml">
                ...
                <div className="col-md-3 mb-3">
                  <Autocomplete
                    ...
                    value={freightList.find((item) => item.type === formData.freightType) || null}
                ...
                <div className="col-md-3 mb-3">
                  <Autocomplete
                    options={originList}
                    getOptionLabel={(option) => (option?.portName ? `${option.portName}` : '')}
                    value={originList.find((item) => item.portName === formData.orgin) || null}
                    onChange={(event, newValue) => {
                      if (newValue) {
                        setFormData((prev) => ({
                          ...prev,
                ...
                <div className="col-md-3 mb-3">
                  <Autocomplete
                    options={originList}
                    getOptionLabel={(option) => (option?.portName ? `${option.portName}` : '')}
                    value={originList.find((item) => item.portName === formData.designation) || null}
                    onChange={(event, newValue) => {
                      if (newValue) {
                        setFormData((prev) => ({
                          ...prev,
                    ...
                    renderInput={(params) => (
                      <TextField
                        {...params}
                        label={<span>Destination Port/Airport {/* <span className="asterisk">*</span> */}</span>}
                        size="small"
                                    ...
                                    <tr key={row.id}>
                                      ...
                                      <td className="border px-2 py-2" style={{ width: '20%' }}>
                                        <Autocomplete
                                          ...
                                          value={currencyList.find((option) => option.currency === row.currency) || null}
                                          onChange={(event, newValue) => {
                                      ...
                                      <td className="border px-2 py-2" style={{ width: '20%' }}>
                                        <Autocomplete
                                          ...
                                          value={calcList.find((option) => option.unitCode === row.calcType) || null}
                                          onChange={(event, newValue) => {
