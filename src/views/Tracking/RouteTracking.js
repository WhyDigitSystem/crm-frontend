...
export default function RouteTracking() {
    ...
    const drawRoute = useCallback(
        ...
        [isLoaded, currentPosition, travelMode]
    );
                ...
                distService.getDistanceMatrix(
                    {
                        origins: [newPos],
                        destinations: [
                            { lat: +selectedLead.latitude, lng: +selectedLead.longitude },
                        ],
                        travelMode: window.google.maps.TravelMode[travelMode],
                    },
                    (res, stat) => {
    ...
    const buildLetterIcon = (letter, color = "#ef5350") => {
      ...
      <path d="M30 0 C10 0 0 20 0 32 C0 50 30 80 30 80 C30 80 60 50 60 32 C60 20 50 0 30 0 Z"
       fill="${color}" />
                    ...
                    <Fade in>
                        ...
                        >
                            ...
                            <Stack direction="row" spacing={1} alignItems="center">
                                ...
                                <Typography sx={{ transition: "0.3s ease" }}>
                                    {distanceText}
                                </Typography>
                            </Stack>
                            <Stack direction="row" spacing={1} alignItems="center">
