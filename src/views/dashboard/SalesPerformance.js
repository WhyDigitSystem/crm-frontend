                    ...
                    <SectionCard title="📊 Sales Performance">
                        ...
                        <Stack direction="row" justifyContent="space-between" mb={1}>
                            <Typography variant="caption" color="text.secondary">
                                ₹{companyTarget.totalAmount.toLocaleString()} of ₹
                                {companyTarget.targetValue.toLocaleString()} · {companyTarget.percentage}% Achieved
                            </Typography>
                            ...
                            <Autocomplete
                                ...
                                renderInput={(params) => (
                                    <TextField {...params} label="Target Basis" />
                                )}
                            />
                        </Stack>
                        ...
                        >
                            <Box
                                sx={{
                                    ...
                                    height: '100%',
                                    bgcolor:
                                        companyTarget.percentage >= 90
                                            ? '#22c55e'
                                            : companyTarget.percentage >= 70
                                                ? '#f59e0b'
                                                : '#ef4444'
                                }}
                            />
                            ...
                            empPerformance.slice(0, 2).map((emp, i) => (
                                ...
                                >
                                    ...
                                    <Typography fontWeight={600}>
                                        ₹{Number(emp.totalAmount).toLocaleString()}
                                    </Typography>
                                </Stack>
                            ))
                        )}
                        ...
                        <Stack spacing={1}>
                            {empPerformance.map((emp, i) => (
                                <Stack key={emp.employeeCode} direction="row" justifyContent="space-between">
                                    <Typography>{i + 1}. {emp.employeeName}</Typography>
